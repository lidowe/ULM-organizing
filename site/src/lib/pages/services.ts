...
<section class="page-next">
  <div class="wrap next-grid">
    <a class="next-card" href="/work">
      ...
      <h3>Records this has already been done on.</h3>
      <p>Exact roles, major-label and independent, across genres. The proof that the method is not theoretical.</p>
    </a>
    <div class="next-cta">
      <p>Or start now, with any topic, any questions, thoughts or files.</p>
      <a class="btn primary" href="/contact">Talk about the project</a>
    </div>
  </div>
</section>
`;
