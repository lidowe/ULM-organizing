...
<section class="section">
  ...
  <div class="wrap remote-body reveal">
    ...
    <div class="needs-content"><strong>Content needed</strong>Decide post cadence and the first three topics. A simple post list and article pages can be wired up whenever you’re ready.</div>
  </div>
</section>
`;
