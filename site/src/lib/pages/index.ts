// Home, rebuilt to the Session Sheet concept and the REBUILD-DRAFT Part B
// read-through (approved plan, Phase 1). The stranger is the reader: their
// situation first, Edward at beat 04 as crew, resolution = "you now have a
// resource." Headings are claims - a headings-only read still delivers the
// whole argument. All copy is draft in Edward's direction, pending his
// beat-numbered veto pass.
export default `
...
<section class="rack-unit">
  <div class="wrap">
    ...
    <div class="unit-prose">
      ...
      <p class="unit-turn">The tools made it all the way to your room. That part worked.</p>
    </div>
  </div>
</section>
...
<section class="rack-unit unit-soft">
  <div class="wrap">
    ...
    <div class="unit-prose">
      ...
      <p>So when your mix dies everywhere except your own room, that is not a talent problem. It is a missing inheritance. And it isn&rsquo;t only you &mdash; the biggest artists on the biggest labels are grinding the same treadmill you are. The machine and the bedroom aren&rsquo;t enemies. They&rsquo;re separated.</p>
      <p class="unit-turn">Separated can be fixed.</p>
    </div>
...
<section class="rack-unit unit-soft">
  <div class="wrap">
    ...
    <div class="unit-prose">
      ...
      <p>When the buildings started closing, the knowledge didn&rsquo;t stop existing. It just stopped having anywhere to go.</p>
...
<section class="rack-unit">
  <div class="wrap">
    ...
    <div class="unit-prose">
      ...
      <p>The paid work is mixing, production, technical repair, and one-on-one teaching. The prices are on the <a class="text-link" href="/services">Services page</a>, with what they include, and independent budgets get met where they are.</p>
      <p class="unit-turn">And the teaching aims at one target on purpose: the day you don&rsquo;t need me. That is not a slogan. It is the success metric.</p>
    </div>
  </div>
</section>
