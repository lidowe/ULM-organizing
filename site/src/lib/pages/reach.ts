...
<section class="section">
  <div class="wrap remote-body reveal">
    ...
    <div class="needs-content"><strong>Details needed</strong>Add a phone or text number, response time, and social links. Booking and scheduling can be added here later.</div>
  </div>
</section>
`;
